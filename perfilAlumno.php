...
include('connectmysql.php');
      ...
      if (empty($errores)) {
          $query= "UPDATE alumno SET nombre_Alumno = '$nombre', apaterno_alumno = '$apaterno', amaterno_alumno = '$amaterno',
          celular_alumno =  '$telefono',  callenumero_alumno = '$direccion',
          municipio = '$municipio'
          WHERE email_alumno = '$id_alum'";
